...
Leveltracker_Hints()
{
	...
	If pic && (settings.features.actdecoder && !Blank(settings.actdecoder.hotkey) || !(settings.features.actdecoder && !settings.actdecoder.generic && (vars.actdecoder.files[StrReplace(vars.log.areaID, "c_") " 1"])))
	{
...
Leveltracker_PobImport(b64, profile)
{
	...
	If !classes
		If vars.poe_version
			classes := {"mercenary": ["tactician", "witchhunter", "gemling legionnaire"], "monk": ["invoker", "acolyte of chayula"], "ranger": ["deadeye", "pathfinder"], "sorceress": ["stormweaver", "chronomancer", "disciple of varashta"], "warrior": ["titan", "warbringer", "smith of kitava"], "witch": ["infernalist", "blood mage", "lich"], "huntress": ["amazon", "ritualist"], "druid": ["oracle", "shaman"]}
