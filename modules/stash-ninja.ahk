Init_stash(refresh := 0)
{
	...
	Else
	{
		...
		settings.stash.leagues := (vars.poe_version ? [["standard", "Standard"], ["abyss", "Rise of the Abyssal"], ["hc abyss", "HC Rise of the Abyssal"]] : [["standard", "Standard"], ["keepers", "Keepers"], ["hc keepers", "Hardcore Keepers"]])
