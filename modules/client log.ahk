...
Log_Loop(mode := 0)
{
	...
	If log_content.Count()
	{
		...
		If settings.features.leveltracker && vars.leveltracker.layouts_lock && !vars.leveltracker.overlays && !Blank(areaID) && (areaID != vars.leveltracker.zone_layouts.current)
		{
